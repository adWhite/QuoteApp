...
var IndexView = React.createClass({
  _start: function() {
    ...
    render: function() {
      return (
        <div className="app-welcome-view animated" ref="welcome">
        ...
        <button className="btn-m btn-black btn-get-started" onClick={this._start}>Get Started</button>
        </div>
        );
    }
});
...
var AppView = React.createClass({
  ...
  render: function() {
    return (
        <div className="app-view _hidden" ref="appView">
          <div className="app-estimated-cost"><span className="app-cost">{this._getStateTotal()}</span></div>
          {this._renderOptions()}
...
var TotalView = React.createClass({
  ...
  render: function() {
    return (
        <div className="app-total-view _hidden" ref="appTotal">
          <div className="row">
...
"What Important Features/Functionality Do You Want/Need? (check all that apply)",
  ...
  render: function() {
    return (
        <div className="app-multi" ref='appMulti'>
...
var Checkbox = React.createClass({
  ...
  render: function() {
    return (
      ...
      <span className="checkbox-name">{this.props.feature}</span>
      </label>
    );
  }  
});
  ...
  render: function() {
    return (
        <form className="app-form-send-quote" ref="form" onSubmit={this._submitForm} >
          ...
          <input name="company_name" type="text" placeholder="Your Company Name (required)" />
          <input name="email" type="text" placeholder="Your E-Mail (required)" />
          <input name="copyto" type="text" placeholder="Copy to yourself or someone else? (required)" />
          <textarea name="comments" placeholder="Any comments? (required)" />
          <input className="btn-orange btn-m" type="submit" />
        </form>
    );  
  }
});
  ...
  render: function() {
    return (
      <div className="app-branding">
        ...
        <p>Thank you for thinking of adWhite for your next website project. Please submit the form below and we’ll be in touch within 24 business hours to discuss next steps.</p>
      </div>
    );
  }
});
...
var ThankYouPageView = React.createClass({
  render: function() {
    return (
      <div class="app-thank-you">
        <img className="app-logo" src="img/adWhite_logo.jpg" alt="adWhite" width="50%" /> 
