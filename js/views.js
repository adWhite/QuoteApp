        ...
        render: function() {
            return (
                React.DOM.form( {className:"app-form-send-quote", ref:"form", onSubmit:this._submitForm} , 
                    React.DOM.input( {name:"name", type:"text", placeholder:"Your Name"} ),
                    React.DOM.input( {name:"email",type:"text", placeholder:"Your E-Mail"} ),
                    React.DOM.input( {name:"copyto", type:"text", placeholder:"Copy to yourself or someone else?"} ),
